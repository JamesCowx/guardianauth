...
export default function AuthDemo() {
    ...
    return (
      <div className="liquid-glass rounded-2xl p-8 text-center space-y-5">
        ...
        <div className="grid grid-cols-3 gap-2">
          {['WebAuthn âœ“', 'IP Trusted', 'Device Known'].map((item) => (
  ...
  return (
    <div className="liquid-glass rounded-2xl p-6 space-y-5 max-w-sm mx-auto">
      <div>
        <div className="w-10 h-10 rounded-xl bg-[#60a5fa]/10 border border-[#60a5fa]/20 flex items-center justify-center text-lg mb-3">ðŸ”</div>
